...
export const MainPage = () => {
  ...
  return (
    <div className='grid md-min:grid-cols-3'>
      <div className='col-span-2 md:hidden h-screen flex justify-center mt-52 font-Montserrat'>
      ...
      <div className='flex flex-col text-text-1 '>
        <div className='font-PretendardMedium mt-28 text-28 md:hidden'>
        ...
        <div className='md:mx-auto md:mt-32'>
